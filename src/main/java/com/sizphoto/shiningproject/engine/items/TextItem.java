...
public class TextItem extends GameItem {
    ...
    private Mesh buildMesh() {
        ...
        for (int i = 0; i < numChars; i++) {
            ...
            // We will represent the vertices using screen coordinates (remember that the origin
            // of the screen coordinates is located at the top left corner).
            // The y coordinate of the vertices on top of the triangles is lower than
